...
DOCS_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "documents", "wso2")

def load_wso2_docs() -> List[Document]:
    docs = []
    ...
    for glob_pattern, loader_cls in loaders.items():
        ...
        try:
            ...
            print(f"Error loading WSO2 documents matching {glob_pattern}: {e}")
